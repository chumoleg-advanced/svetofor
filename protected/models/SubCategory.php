 ...
 */
class SubCategory extends MyActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, name, status, category_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'relProductSubcategories' => array(self::HAS_MANY, 'RelProductSubcategory', 'sub_category_id'),
